...
CREATE INDEX idx_razorpay_orders_razorpay_order_id ON public.razorpay_orders(razorpay_order_id);
CREATE INDEX idx_razorpay_payments_user_id ON public.razorpay_payments(user_id);
CREATE INDEX idx_razorpay_payments_razorpay_payment_id ON public.razorpay_payments(razorpay_payment_id);
