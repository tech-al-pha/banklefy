...
export const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "featuresPage.items.chatAura.desc": "Due to an issue, Chat Aura is temporarily unavailable.",
    ...
    "featuresPage.items.exportFormats.desc": "Export to Excel, CSV, JSON, and MT940 reports — optimized for accounting and analysis.",
  ...
  "es": {
    ...
    "featuresPage.items.exportFormats.desc": "Exporte informes a Excel, CSV, JSON y MT940, optimizados para contabilidad y análisis.",
