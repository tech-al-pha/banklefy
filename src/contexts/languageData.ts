...
export const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "aboutPage.visionP1": "Banklefy isn't just a tool; it's a global standard for financial data integrity. In an era where data is the new currency, we've engineered a platform that doesn't just convert files — it secures your entire financial workflow.",
    ...
    "aboutPage.brainchildP2": "By fusing advanced encryption with seamless AI automation, Banklefy launched in 2026 to empower businesses with instant, high-integrity bank statement page processing while keeping data private.",
    ...
    "privacyPage.aboutP2Suffix": ", a cybersecurity student from Harvard University, based in Kota, Rajasthan, India. In 2026, at the age of 18, Faizan launched Banklefy to help individuals and businesses save time and effort with financial data.",
  ...
  "es": {
    ...
    "aboutPage.visionP1": "Banklefy no es sólo una herramienta; es un estándar global para la integridad de los datos financieros. En una era en la que los datos son la nueva moneda, hemos diseñado una plataforma que no solo convierte archivos, sino que protege todo su flujo de trabajo financiero.",
    ...
    "aboutPage.brainchildP2": "Al fusionar el cifrado avanzado con una perfecta automatización de la IA, Banklefy se lanzó en 2026 para capacitar a las empresas con conversiones de extractos bancarios instantáneas y de alta integridad, manteniendo sus datos tan privados como poderosos.",
    ...
    "privacyPage.aboutP2Suffix": ", estudiante de ciberseguridad de la Universidad de Harvard, con sede en Kota, Rajasthan, India. En 2026, a la edad de 18 años, Faizan lanzó Banklefy para ayudar a personas y empresas a ahorrar tiempo y esfuerzo con datos financieros.",
