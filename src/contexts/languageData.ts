...
export const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "featuresPage.items.zeroRetention.desc": "Files stay available only during your active session so you can download, then they’re removed.",
    ...
    "aboutPage.visionP1": "Banklefy is built to keep financial data accurate and secure. In a time where data matters, we focus on clean conversions and careful handling of sensitive statements.",
    "aboutPage.brainchildPrefix": "The Brainchild of",
    "aboutPage.brainchildP1": "Built by a security-focused founder based in Kota, Rajasthan, with a focus on safer handling of sensitive financial documents.",
    "aboutPage.brainchildP2": "By combining practical security practices with streamlined automation, Banklefy launched in 2026 to help businesses convert bank statements quickly while keeping data private.",
    ...
    "privacyPage.sections.zeroRetention.title": "Session-Based Access",
    "privacyPage.sections.zeroRetention.desc": "Uploaded files and generated results are available during your active session. Download files while the session is active.",
  ...
  "ar": {
    ...
    "featuresPage.items.zeroRetention.desc": "تظل الملفات متاحة فقط أثناء الجلسة النشطة للتنزيل ثم تُحذف.",
    ...
    "aboutPage.visionP1": "Banklefy أداة تركز على دقة البيانات المالية وحمايتها. في زمن أصبحت فيه البيانات مهمة، نركز على تحويلات نظيفة ومعالجة حذرة للمستندات الحساسة.",
    "aboutPage.brainchildPrefix": "من بنات أفكار",
    "aboutPage.brainchildP1": "تم بناؤه على يد مؤسس يركز على الأمن السيبراني ومقره في كوتا، راجستان، بهدف حماية المستندات المالية الحساسة.",
    "aboutPage.brainchildP2": "من خلال دمج ممارسات أمنية عملية مع أتمتة سلسة، تم إطلاق Banklefy في عام 2026 لمساعدة الشركات على تحويل كشوف الحساب بسرعة مع الحفاظ على الخصوصية.",
  ...
  "zh": {
    ...
    "featuresPage.items.zeroRetention.desc": "文件仅在当前会话可用以便下载，之后会被移除。",
    ...
    "aboutPage.visionP1": "Banklefy 专注于金融数据的准确性与安全性。在数据至关重要的时代，我们致力于干净的转换与谨慎的敏感文件处理。",
    "aboutPage.brainchildPrefix": "的创意",
    "aboutPage.brainchildP1": "由位于拉贾斯坦邦科塔的安全导向型创始人打造，目标是更安全地处理敏感金融文件。",
    "aboutPage.brainchildP2": "通过结合务实的安全实践与流畅的自动化，Banklefy 于 2026 年推出，帮助企业快速转换银行对账单并保护隐私。",
  ...
  "es": {
    ...
    "featuresPage.items.zeroRetention.desc": "Los archivos solo están disponibles durante tu sesión activa para descargar y luego se eliminan.",
    ...
    "aboutPage.visionP1": "Banklefy está diseñado para mantener los datos financieros precisos y seguros. En una era donde los datos importan, nos enfocamos en conversiones limpias y un manejo cuidadoso de documentos sensibles.",
    "aboutPage.brainchildPrefix": "La creación de",
    "aboutPage.brainchildP1": "Creado por un fundador enfocado en la seguridad, con sede en Kota, Rajasthan, para proteger documentos financieros sensibles.",
    "aboutPage.brainchildP2": "Al combinar prácticas de seguridad con automatización fluida, Banklefy se lanzó en 2026 para ayudar a las empresas a convertir extractos rápidamente manteniendo la privacidad.",
    ...
    "privacyPage.sections.zeroRetention.desc": "Los archivos cargados y los resultados están disponibles durante la sesión activa. Descárguelos antes de cerrar la sesión.",
  ...
  "hi": {
    ...
    "featuresPage.items.zeroRetention.desc": "फ़ाइलें केवल आपकी active session के दौरान download के लिए उपलब्ध रहती हैं, फिर हटा दी जाती हैं।",
    ...
    "aboutPage.visionP1": "Banklefy वित्तीय डेटा की सटीकता और सुरक्षा पर केंद्रित है। ऐसे समय में जब डेटा महत्वपूर्ण है, हम साफ़ कन्वर्ज़न और संवेदनशील दस्तावेज़ों की सावधानीपूर्ण हैंडलिंग पर ध्यान देते हैं।",
    "aboutPage.brainchildPrefix": "के दिमाग की उपज",
    "aboutPage.brainchildP1": "कोटा, राजस्थान स्थित सुरक्षा-केंद्रित संस्थापक द्वारा बनाया गया, ताकि संवेदनशील वित्तीय दस्तावेज़ों को अधिक सुरक्षित तरीके से संभाला जा सके।",
    "aboutPage.brainchildP2": "व्यावहारिक सुरक्षा अभ्यास और सहज ऑटोमेशन को जोड़कर, Banklefy 2026 में लॉन्च हुआ ताकि व्यवसाय तेज़ी से बैंक स्टेटमेंट कन्वर्ट कर सकें और डेटा निजी रहे।",
