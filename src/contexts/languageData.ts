...
export const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "docsPage.sections.security.desc": "Your data is handled securely with session-based access.",
    "faqPage.badge": "FAQs",
    ...
    "faqPage.items.storage.desc": "Files are available during your session for download, then removed.",
    ...
    "securityPage.sections.dataHandling.desc": "Files are processed to generate exports. We do not sell data and we restrict access to your session.",
    ...
    "securityPage.sections.access.desc": "Only you can access your files and exports during your session.",
    "securityPage.sections.retention.title": "Retention & deletion",
    "securityPage.sections.retention.desc": "We avoid long-term storage; downloads are session-based.",
  ...
  "ar": {
    ...
    "docsPage.sections.security.desc": "يتم التعامل مع البيانات بأمان مع وصول يعتمد على الجلسة.",
    ...
    "faqPage.items.storage.desc": "الملفات متاحة أثناء الجلسة للتنزيل ثم تُزال.",
    ...
    "securityPage.sections.dataHandling.desc": "تتم معالجة الملفات لإنشاء الصادرات. نحن لا نبيع البيانات ونقيد الوصول بجلسة المستخدم.",
    ...
    "securityPage.sections.access.desc": "فقط أنت يمكنه الوصول إلى ملفاتك وصادراتك أثناء الجلسة.",
    "securityPage.sections.retention.title": "الاحتفاظ والحذف",
    "securityPage.sections.retention.desc": "نتجنب التخزين طويل المدى؛ التنزيلات تعتمد على الجلسة.",
  ...
  "zh": {
    ...
    "docsPage.sections.security.desc": "数据以会话方式安全处理。",
    "faqPage.badge": "常见问题",
    ...
    "faqPage.items.storage.desc": "文件在会话期间可下载，之后移除。",
    ...
    "securityPage.sections.dataHandling.desc": "文件用于生成导出结果。我们不出售数据，并将访问限制在你的会话内。",
    ...
    "securityPage.sections.access.desc": "只有你可以在会话期间访问你的文件和导出。",
    "securityPage.sections.retention.title": "保留与删除",
    "securityPage.sections.retention.desc": "我们避免长期存储；下载基于会话。",
  ...
  "es": {
    ...
    "docsPage.sections.security.desc": "Datos manejados con acceso basado en sesión.",
    ...
    "faqPage.items.storage.desc": "Los archivos están disponibles durante la sesión y luego se eliminan.",
    ...
    "securityPage.sections.dataHandling.desc": "Los archivos se procesan para generar exportaciones. No vendemos datos y limitamos el acceso a tu sesión.",
    ...
    "securityPage.sections.access.desc": "Solo tú puedes acceder a tus archivos y exportaciones durante tu sesión.",
    "securityPage.sections.retention.title": "Retención y eliminación",
    "securityPage.sections.retention.desc": "Evitamos almacenamiento a largo plazo; las descargas son por sesión.",
  ...
  "hi": {
    ...
    "docsPage.sections.security.desc": "डेटा सेशन-बेस्ड एक्सेस के साथ सुरक्षित तरीके से हैंडल होता है।",
    ...
    "faqPage.items.storage.desc": "फाइलें सेशन के दौरान डाउनलोड के लिए उपलब्ध रहती हैं, फिर हट जाती हैं।",
    ...
    "securityPage.sections.dataHandling.desc": "फ़ाइलें एक्सपोर्ट के लिए प्रोसेस होती हैं। हम डेटा नहीं बेचते और एक्सेस को आपकी सेशन तक सीमित रखते हैं।",
    ...
    "securityPage.sections.access.desc": "सेशन के दौरान सिर्फ आप ही अपनी फ़ाइलें और एक्सपोर्ट देख सकते हैं।",
    "securityPage.sections.retention.title": "रिटेंशन और डिलीशन",
    "securityPage.sections.retention.desc": "हम लंबे समय तक स्टोरेज से बचते हैं; डाउनलोड सेशन-बेस्ड होते हैं।",
