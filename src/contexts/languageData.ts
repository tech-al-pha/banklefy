...
export const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "featuresPage.items.zeroRetention.desc": "Files remain available while your current session is active.",
  ...
  "es": {
    ...
    "featuresPage.items.zeroRetention.desc": "Los archivos están disponibles mientras la sesión esté activa.",
