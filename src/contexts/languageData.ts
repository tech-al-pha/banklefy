...
export const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "footer.help.item3": "Daily limits: anonymous 2 pages/day, free 5 pages/day, paid by plan",
    ...
    "featuresPage.subtitle": "Complete A-Z list of everything Akromeda offers - from AI-powered OCR to privacy-first processing. Built for accuracy, speed, and clear financial analysis.",
    ...
    "featuresPage.items.pdfReport.desc": "Create branded PDF reports with summaries, underwriting metrics, and detailed breakdowns — ideal for audits and loan applications.",
    ...
    "featuresPage.items.instantProcessing.desc": "Fast page processing in under ~30 seconds — ideal for time-sensitive accounting and audits.",
    ...
    "featuresPage.items.chatAura.desc": "Ask questions about your statement and get insights on transactions, cash flow, and spending patterns.",
    ...
    "featuresPage.items.exportFormats.desc": "Export to Excel, CSV, DOCX, and ODS reports — optimized for accounting and analysis.",
    ...
    "featuresPage.cta.desc": "Start with 2 free pages per day. Sign up for 5 pages per day and unlock the full power of Akromeda.",
    ...
    "aboutPage.visionP1": "Akromeda isn't just a tool; it's a global standard for financial data integrity. In an era where data is the new currency, we've engineered a platform that doesn't just convert files — it secures your entire financial workflow.",
    "aboutPage.brainchildPrefix": "The Brainchild of",
    "aboutPage.brainchildP1": "Architected by a dedicated cybersecurity specialist from Harvard University, based in Kota, Rajasthan. At just 18 years old, Faizan identified a critical vulnerability in how sensitive financial documents were handled globally.",
    "aboutPage.brainchildP2": "By fusing advanced encryption with seamless AI automation, Akromeda launched in 2026 to empower businesses with instant, high-integrity bank statement page processing while keeping data private.",
    ...
    "privacyPage.aboutP1": "Akromeda is a smart, fast, and secure tool built to convert bank statements from PDF to Excel with precision and ease.",
    "privacyPage.aboutP2Prefix": "This platform was created by",
    "privacyPage.aboutP2Suffix": ", a cybersecurity student from Harvard University, based in Kota, Rajasthan, India. In 2026, at the age of 18, Faizan launched Akromeda to help individuals and businesses save time and effort with financial data.",
  ...
  "ar": {
    ...
    "featuresPage.subtitle": "قائمة كاملة من الألف إلى الياء بكل ما تقدمه Akromeda - بدءًا من التعرف الضوئي على الحروف المدعوم بالذكاء الاصطناعي وحتى المعالجة التي تعتمد على الخصوصية أولاً. مصممة لتحقيق الدقة والسرعة والتحليل المالي الواضح.",
    ...
    "featuresPage.items.chatAura.desc": "اطرح أسئلة حول كشف حسابك واحصل على رؤى حول المعاملات والتدفق النقدي وأنماط الإنفاق.",
    ...
    "featuresPage.items.zeroRetention.title": "الاحتفاظ لمدة 24 ساعة",
    "featuresPage.items.zeroRetention.desc": "يتم الاحتفاظ بالملفات والنتائج لمدة تصل إلى 24 ساعة للتنزيل، ثم يتم حذفها.",
    ...
    "featuresPage.items.exportFormats.desc": "قم بالتصدير إلى تقارير Excel وCSV وDOCX وODS - المُحسّنة للمحاسبة والتحليل.",
    ...
    "featuresPage.cta.desc": "ابدأ بصفحتين مجانيتين يوميًا. قم بالتسجيل لمدة 5 صفحات يوميًا واحصل على القوة الكاملة لـ Akromeda.",
    ...
    "aboutPage.brainchildP2": "من خلال دمج التشفير المتقدم مع التشغيل الآلي السلس للذكاء الاصطناعي، تم إطلاق Akromeda في عام 2026 لتمكين الشركات من خلال تحويلات كشف الحساب البنكي الفورية وعالية التكامل - مع الحفاظ على خصوصية بياناتك بقدر ما هي قوية.",
    ...
    "aboutPage.contact.hqValue": "بريم ناجار 1، كوتا، راجاستان 324004",
    ...
    "privacyPage.sections.zeroRetention.title": "الاحتفاظ لمدة 24 ساعة",
    "privacyPage.sections.zeroRetention.desc": "يتم تخزين الملفات التي تم تحميلها والنتائج التي تم إنشاؤها لمدة تصل إلى 24 ساعة للسماح لك بتنزيلها. يجب عليك تنزيل ملفاتك بنفسك؛ نحن لا نقوم بتنزيل الملفات أو استردادها أو حذفها يدويًا نيابةً عنك. وبعد مرور 24 ساعة، يتم حذف الملفات والنتائج نهائيًا ولا يمكن استعادتها.",
    ...
    "privacyPage.aboutP1": "Akromeda هي أداة ذكية وسريعة وآمنة مصممة لتحويل البيانات المصرفية من PDF إلى Excel بدقة وسهولة.",
    "privacyPage.aboutP2Prefix": "تم إنشاء هذه المنصة بواسطة",
    "privacyPage.aboutP2Suffix": "، طالب في مجال الأمن السيبراني من جامعة هارفارد، ومقره في كوتا، راجاستان، الهند. في عام 2026، عندما كان عمره 18 عامًا، أطلق فايزان Akromeda لمساعدة الأفراد والشركات على توفير الوقت والجهد فيما يتعلق بالبيانات المالية.",
  ...
  "zh": {
    ...
    "auth.canUse": "您现在可以开始使用 Akromeda。",
    "auth.email": "电子邮件",
    "auth.password": "密码",
    "auth.signIn": "登入",
    "auth.signUp": "报名",
    ...
    "featuresPage.subtitle": "Akromeda 提供的所有功能的完整 A-Z 列表 - 从人工智能驱动的 OCR 到隐私优先的处理。专为准确性、速度和清晰的财务分析而构建。",
    ...
    "featuresPage.items.chatAura.desc": "询问有关您的报表的问题，并了解有关交易、现金流和支出模式的见解。",
    "featuresPage.items.encryption.title": "运输途中加密",
    "featuresPage.items.encryption.desc": "数据在上传和传输过程中进行加密，以保护敏感的财务数据。",
    "featuresPage.items.zeroRetention.title": "24小时保留",
    "featuresPage.items.zeroRetention.desc": "文件和结果最多保留 24 小时以供下载，然后删除。",
    ...
    "featuresPage.items.exportFormats.desc": "导出为 Excel、CSV、DOCX 和 ODS 报告 - 针对会计和分析进行了优化。",
    ...
    "featuresPage.cta.desc": "从每天 2 个免费页面开始。每天注册 5 页即可解锁 Akromeda 的全部功能。",
    ...
    "aboutPage.visionP1": "Akromeda 不仅仅是一个工具；更是一个工具。它是金融数据完整性的全球标准。在数据成为新货币的时代，我们设计的平台不仅能转换文件，还能保护您的整个财务工作流程。",
    ...
    "aboutPage.brainchildP2": "Akromeda 于 2026 年推出，将先进的加密技术与无缝的 AI 自动化相融合，为企业提供即时、高完整性的银行对账单转换服务，让您的数据保持私密性和强大性。",
    ...
    "aboutPage.contact.hqValue": "Prem Nagar 1st, 科塔, 拉贾斯坦邦 324004",
    ...
    "privacyPage.sections.zeroRetention.title": "24 小时保留",
    "privacyPage.sections.zeroRetention.desc": "上传的文件和生成的结果最多会存储 24 小时，以便您下载。您必须自行下载文件；我们不会代表您下载、检索或手动删除文件。 24 小时后，文件和结果将被永久删除且无法恢复。",
    ...
    "privacyPage.aboutP1": "Akromeda 是一款智能、快速且安全的工具，旨在精确轻松地将银行对账单从 PDF 转换为 Excel。",
    "privacyPage.aboutP2Prefix": "这个平台的创建者是",
    "privacyPage.aboutP2Suffix": "，来自哈佛大学的网络安全学生，位于印度拉贾斯坦邦科塔。 2026 年，18 岁的 Faizan 推出了 Akromeda，帮助个人和企业利用财务数据节省时间和精力。",
  ...
  "es": {
    ...
    "footer.copyright": "© 2026 Akrómeda. Creado por Faizan Rizvi.",
    ...
    "auth.canUse": "Ahora puedes empezar a utilizar Akromeda.",
    ...
    "featuresPage.subtitle": "Lista completa de la A a la Z de todo lo que ofrece Akromeda, desde OCR con tecnología de inteligencia artificial hasta procesamiento que prioriza la privacidad. Creado para ofrecer precisión, velocidad y análisis financieros claros.",
    ...
    "featuresPage.items.pdfReport.desc": "Cree informes PDF personalizados con resúmenes, métricas de suscripción y desgloses detallados, ideales para auditorías y solicitudes de préstamos.",
    ...
    "featuresPage.items.instantProcessing.desc": "Conversiones rápidas en menos de ~30 segundos: ideal para contabilidad y auditorías urgentes.",
    ...
    "featuresPage.items.chatAura.desc": "Haga preguntas sobre su estado de cuenta y obtenga información sobre transacciones, flujo de efectivo y patrones de gasto.",
    ...
    "featuresPage.items.zeroRetention.title": "RETENCIÓN 24 HORAS",
    "featuresPage.items.zeroRetention.desc": "Los archivos y resultados se conservan hasta 24 horas para su descarga y luego se eliminan.",
    ...
    "featuresPage.items.exportFormats.desc": "Exporte informes a Excel, CSV, DOCX y ODS, optimizados para contabilidad y análisis.",
    ...
    "featuresPage.cta.desc": "Comience con 2 páginas gratis por día. Regístrate para recibir 5 páginas por día y desbloquea todo el poder de Akromeda.",
    "featuresPage.cta.tryDemo": "Pruebe la demostración ahora",
    "featuresPage.cta.signUp": "Regístrate gratis",
    "featuresPage.footer": "© 2026 Akrómeda | Diseñado para la excelencia",
    "aboutPage.visionTitle": "La visión",
    "aboutPage.visionSubtitle": "Donde la precisión se encuentra con la ciberseguridad.",
    "aboutPage.visionP1": "Akromeda no es sólo una herramienta; es un estándar global para la integridad de los datos financieros. En una era en la que los datos son la nueva moneda, hemos diseñado una plataforma que no solo convierte archivos, sino que protege todo su flujo de trabajo financiero.",
    "aboutPage.brainchildPrefix": "La creación de",
    "aboutPage.brainchildP1": "Diseñado por un dedicado especialista en ciberseguridad de la Universidad de Harvard, con sede en Kota, Rajasthan. Con sólo 18 años, Faizan identificó una vulnerabilidad crítica en la forma en que se manejaban los documentos financieros confidenciales a nivel mundial.",
    "aboutPage.brainchildP2": "Al fusionar el cifrado avanzado con una perfecta automatización de la IA, Akromeda se lanzó en 2026 para capacitar a las empresas con conversiones de extractos bancarios instantáneas y de alta integridad, manteniendo sus datos tan privados como poderosos.",
    "aboutPage.valueProps.cyberSafe.title": "Ciberseguro",
    "aboutPage.valueProps.cyberSafe.desc": "Creado con principios de seguridad primero para flujos de trabajo financieros sensibles.",
    "aboutPage.valueProps.instantFlux.title": "Flujo instantáneo",
    "aboutPage.valueProps.instantFlux.desc": "Convierta datos complejos rápidamente, sin entrada manual.",
    "aboutPage.valueProps.accuracy.title": "Alta precisión",
    "aboutPage.valueProps.accuracy.desc": "Conversión centrada en la precisión diseñada para datos financieros de alto riesgo.",
    ...
    "aboutPage.contact.hqValue": "Prem Nagar 1º, Kota, Rajasthan 324004",
    "aboutPage.footer": "© 2026 Akrómeda | Diseñado para la excelencia",
    ...
    "privacyPage.sections.zeroRetention.title": "Retención de 24 horas",
    "privacyPage.sections.zeroRetention.desc": "Los archivos cargados y los resultados generados se almacenan por hasta 24 horas para permitirle descargarlos. Debe descargar sus archivos usted mismo; No descargamos, recuperamos ni eliminamos archivos manualmente en su nombre. Después de 24 horas, los archivos y resultados se eliminan permanentemente y no se pueden recuperar.",
    ...
    "privacyPage.aboutTitle": "Acerca de Akrómeda",
    "privacyPage.aboutP1": "Akromeda es una herramienta inteligente, rápida y segura creada para convertir extractos bancarios de PDF a Excel con precisión y facilidad.",
    "privacyPage.aboutP2Prefix": "Esta plataforma fue creada por",
    "privacyPage.aboutP2Suffix": ", estudiante de ciberseguridad de la Universidad de Harvard, con sede en Kota, Rajasthan, India. En 2026, a la edad de 18 años, Faizan lanzó Akromeda para ayudar a personas y empresas a ahorrar tiempo y esfuerzo con datos financieros.",
    "privacyPage.whatTitle": "¿Qué hace Akrómeda?",
    ...
    "settings.usage.subscription": "Plan de suscripción",
    "settings.usage.subscriptionDesc": "Su nivel de suscripción actual",
    ...
    "helpPage.sections.refunds.desc": "Los reembolsos están disponibles dentro de los 14 días para los planes elegibles. Los reembolsos no están disponibles si se consume el 35% o más del uso. Póngase en contacto con el soporte con su ID de pedido.",
  ...
  "hi": {
    ...
    "featuresPage.items.chatAura.desc": "अपने विवरण के बारे में प्रश्न पूछें और लेनदेन, नकदी प्रवाह और खर्च के पैटर्न पर जानकारी प्राप्त करें।",
    ...
    "featuresPage.items.zeroRetention.title": "24 घंटे प्रतिधारण",
    "featuresPage.items.zeroRetention.desc": "फ़ाइलें और परिणाम डाउनलोड के लिए 24 घंटे तक रखे जाते हैं, फिर हटा दिए जाते हैं।",
    ...
    "featuresPage.items.exportFormats.desc": "Excel, CSV, DOCX और ODS रिपोर्ट में निर्यात करें - लेखांकन और विश्लेषण के लिए अनुकूलित।",
    ...
    "aboutPage.contact.hqValue": "प्रेम नगर 1, कोटा, राजस्थान 324004",
    ...
    "privacyPage.sections.zeroRetention.title": "24 घंटे प्रतिधारण",
    "privacyPage.sections.zeroRetention.desc": "अपलोड की गई फ़ाइलें और जेनरेट किए गए परिणाम 24 घंटे तक संग्रहीत रहते हैं ताकि आप उन्हें डाउनलोड कर सकें। आपको अपनी फ़ाइलें स्वयं डाउनलोड करनी होंगी; हम आपकी ओर से फ़ाइलों को डाउनलोड, पुनर्प्राप्त या मैन्युअल रूप से हटाते नहीं हैं। 24 घंटों के बाद, फ़ाइलें और परिणाम स्थायी रूप से हटा दिए जाते हैं और उन्हें पुनर्प्राप्त नहीं किया जा सकता है।",
