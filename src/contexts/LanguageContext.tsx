...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'helpPage.subtitle': 'Everything you need to convert statements smoothly.',
  ...
  zh: {
    ...
    'common.back': '返回',
    'featuresPage.items.dailyLimits.desc': '限额于本地时间午夜重置。匿名用户2次/天，注册用户5次/天。',
    ...
    'featuresPage.items.refunds.desc': '针对付费转换失败的清晰退款流程，由支持团队协助处理。',
    'helpPage.title': '帮助中心',
    'helpPage.subtitle': '这里是转换对账单所需的全部帮助。',
    'helpPage.sections.files.title': '支持的文件',
    'helpPage.sections.password.title': '密码保护的PDF',
  ...
  ja: {
    ...
    'auth.secureAccess': '安全アクセス',
    'common.back': '戻る',
    'featuresPage.items.dailyLimits.desc': '制限は現地時間の0時にリセット。匿名は2回/日、登録は5回/日。',
  ...
  es: {
    ...
    'common.back': 'Volver',
    'featuresPage.items.dailyLimits.desc': 'Los límites se reinician a medianoche. Anónimo: 2/día; registrado: 5/día.',
    ...
    'featuresPage.items.refunds.desc': 'Proceso claro de reembolso para conversiones pagadas fallidas, con apoyo del equipo.',
    ...
    'helpPage.sections.password.title': 'PDF con contraseña',
  ...
  it: {
    ...
    'auth.secureAccess': 'Accesso sicuro',
    'common.back': 'Indietro',
    'featuresPage.items.dailyLimits.desc': 'Limiti che si resettano a mezzanotte. Anonimo: 2/giorno; registrato: 5/giorno.',
    ...
    'featuresPage.items.refunds.desc': 'Procedura chiara di rimborso per conversioni a pagamento non riuscite, con supporto del team.',
    ...
    'helpPage.sections.password.title': 'PDF protetti da password',
  ...
  ar: {
    ...
    'common.back': 'رجوع',
    'featuresPage.items.dailyLimits.desc': 'تُعاد الحدود يوميًا عند منتصف الليل بالتوقيت المحلي. المستخدم المجهول: 2/يوم؛ المسجل: 5/يوم.',
    ...
    'featuresPage.items.refunds.desc': 'عملية استرداد واضحة للتحويلات المدفوعة الفاشلة بدعم من الفريق.',
