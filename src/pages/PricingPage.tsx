...
const perConversionPlans: Plan[] = [
  {
    ...
    amountInRupee: 49,
    unit: "/conversion",
    description: "Login required at checkout. Perfect for one-off conversions.",
    statements: "10 Pages",
  ...
  },
  {
    ...
    amountInRupee: 99,
    unit: "/conversion",
    description: "Login required at checkout. Best for small one-off conversions.",
    statements: "25 Pages",
    features: ["XLSX", "CSV", "★ Pricing mismatch", "★ Circular trading"],
    highlighted: true,
  },
  {
    ...
    amountInRupee: 149,
    unit: "/conversion",
    description: "Login required at checkout. Ideal for larger one-off conversions.",
    statements: "50 Pages",
    features: ["XLSX", "CSV", "★ Pricing mismatch", "★ Circular trading"],
  },
];
...
const comparisonTables: ComparisonTable[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "JSON", values: ["No", "No", "No"] },
      { label: "MT940", values: ["No", "No", "No"] },
...
const PricingPage = () => {
  ...
  const renderPlanCard = (plan: Plan) => {
    ...
    return (
      ...
      >
        {plan.highlighted && (
          <Badge className="absolute -top-3 left-4 bg-primary text-primary-foreground border-0 font-bold px-4 py-1 uppercase tracking-wider text-xs shadow-md">
            Most Popular
          </Badge>
        )}
