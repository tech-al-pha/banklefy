...
export const FraudAlertPanel = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="ultra-glass-panel card-3d-surface p-4 !bg-[#191919] border-primary/20">
      ...
      <div className="grid grid-cols-4 gap-3">
        <Card className={`ultra-glass-panel card-3d-surface p-3 !bg-[#191919] ${balanceMismatches > 0 ? 'bg-ink/60 border-border/60' : 'bg-surface-elevated/20 border-border/40'}`}>
        ...
        <Card className="ultra-glass-panel card-3d-surface p-3 !bg-[#191919] border-primary/20">
          <div className="flex items-center gap-2 text-xs label-muted mb-1">
        ...
        <Card className={`ultra-glass-panel card-3d-surface p-3 !bg-[#191919] ${maxDip.amount <= 0 ? 'bg-ink/60 border-border/60' : 'bg-muted/30 border-border/30'}`}>
          <div className="flex items-center gap-2 text-xs label-muted mb-1">
        ...
        <Card className={`ultra-glass-panel card-3d-surface p-3 !bg-[#191919] ${riskFlags.length > 0 ? 'bg-ink/60 border-border/60' : 'bg-surface-elevated/20 border-border/40'}`}>
          <div className="flex items-center gap-2 text-xs label-muted mb-1">
      ...
      {transactionAlerts.length > 0 ? (
        <Card className="ultra-glass-panel card-3d-surface p-4 !bg-[#191919] border-border/50">
        ...
        <Card className="ultra-glass-panel card-3d-surface p-4 !bg-[#191919] border-border/40">
        ...
        <Card className="ultra-glass-panel card-3d-surface p-4 !bg-[#191919] border-border/50">
          ...
          <div className="space-y-3">
            {editedPdfCheckResult ? (
              <div className={`ultra-glass-panel card-3d-panel rounded-lg border p-3 ${editedPdfCheckResult.status === "suspected" ? "tone-moderate-bg tone-moderate-border" : "tone-excellent-bg tone-excellent-border"}`}>
            ...
            {documentAlerts.length > 0 ? (
              <div className="space-y-2">
                {documentAlerts.map((alert, index) => (
                  <div key={`${alert.type}-${index}`} className="ultra-glass-panel card-3d-panel rounded-lg border border-white/10 bg-white/[0.03] p-3">
                    <div className="flex items-center gap-2">
